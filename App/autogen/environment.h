...
Q_IMPORT_QML_PLUGIN(CheckPaymentFormContentPlugin)
Q_IMPORT_QML_PLUGIN(CheckPaymentFormPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/CheckPaymentFormContent/App.qml";
